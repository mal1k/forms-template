        ...
        <ul class="form-section page-section">
            ...
            <li class="form-line" data-type="control_textbox" id="id_5">
                ...
                <div id="cid_5" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_5" name="initial1" data-type="input-textbox"
            ...
            <li class="form-line" data-type="control_textbox" id="id_51">
                ...
                <div id="cid_51" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_51" name="initial2" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
            ...
            <li class="form-line" data-type="control_textbox" id="id_53">
                ...
                <div id="cid_53" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_53" name="initial3" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
            ...
            <li class="form-line" data-type="control_textbox" id="id_55">
                ...
                <div id="cid_55" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_55" name="initial4" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
            ...
            <li class="form-line" data-type="control_textbox" id="id_58">
                ...
                <div id="cid_58" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_58" name="initial5" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_58">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_59">
                ...
                <div id="cid_59" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_59" name="initial6" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
            ...
            <li class="form-line" data-type="control_textbox" id="id_61">
                ...
                <div id="cid_61" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_61" name="initial7" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_61">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_63">
                ...
                <div id="cid_63" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_63" name="initial8" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_63">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_65">
                ...
                <div id="cid_65" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_65" name="initial9" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_65">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_67">
                ...
                <div id="cid_67" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_67" name="initial10" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_67">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_71">
                ...
                <div id="cid_71" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_71" name="initial11" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_71">
                </div>
            </li>
            ...
            <li class="form-line" data-type="control_textbox" id="id_72">
                ...
                <div id="cid_72" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_72" name="initial12" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_72">
                </div>
            </li>
            ...
            <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_8">
                ...
                <div id="cid_8" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_8" name="psychologist_field"
                        data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px"
                        size="310" value="" data-component="textbox" aria-labelledby="label_8">
                </div>
            </li>
            ...
            <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_75">
                ...
                <div id="cid_75" class="form-input-wide" data-layout="half">
                    <input type="text" id="input_75" name="medicare_field" data-type="input-textbox"
                        class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                        data-component="textbox" aria-labelledby="label_75">
                </div>
            </li>
